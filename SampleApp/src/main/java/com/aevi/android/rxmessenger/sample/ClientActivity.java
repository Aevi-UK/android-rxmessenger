...
public class ClientActivity extends AppCompatActivity implements ActivityFinishRequestListener.OnFinishListener {

    private static final ComponentName SERVICE = new ComponentName("com.aevi.android.rxmessenger.sample", "com.aevi.android.rxmessenger.sample.SampleService");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityFinishRequestListener.getInstance().addOnFinishListener(this);
    }

    @OnClick(R.id.bind)
    public void onBindToService() {
        messengerClient.connect().subscribe(() -> status.setText(R.string.connected_to_service_with_stream), throwable -> status.setText(getString(R.string.failed_to_connect, throwable.getMessage())));
    }
